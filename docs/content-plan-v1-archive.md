...
- 🕒 best-korean-banks-for-foreigners-compared — Hana EZ/SOL Global/Quick Send/WON Global 4사 비교, 목적별 선택 (2026-09-03 예약, draft, 업데이트형)
- 🕒 korean-check-card-vs-credit-card-for-foreigners — 후불교통=신용기능 별도심사·비자목록/점수기준 통념 교정·증빙 문서표 (2026-09-06 예약, draft)
...
- ✅ car-ownership-taxes-and-costs-korea — 취득세 과세표준 시가표준액 하한·공채 1600cc 면제·지방교육세 30%·신조차 검사 5년 (2026-08-30 발행) — Cars 클러스터 완성 7/7
...
- ✅ sole-proprietor-vs-corporation-korea — 2026 법인세 인상 반영·인출층 이중과세·가지급금 4.6%·D-8-3/D-9-4 구분 (2026-08-31 발행)
- 🕒 korean-vat-for-small-business-owners — 간이 기준 1억400만 교정·부가가치율 표·0.5% 공제와 환급 불가·4800만 납부면제≠신고면제 (2026-09-05 예약, draft)
...
- 2026-08-30 신청 (게시자 ID `ca-pub-6014562863132369`, 메타태그 방식으로 소유권 확인 → 검토 요청 완료)
- 신청 시점: 28편 발행 / GSC 노출 208·클릭 5 (3개월)
- 광고 슬롯은 `AdSlot.astro`에서 `hidden` 유지 중 — 승인 후 해제
- 승인 후 할 일: `public/ads.txt` 추가, 슬롯 3개(top/mid/bottom)에 광고 단위 코드 삽입
- 미하엘아카이브는 2026-08-26 선신청 (심사 중)
