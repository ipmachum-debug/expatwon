...
keyFacts:
  ...
  - { label: 'Kiosks and apps', value: 'The hardest cases' }
  - { label: 'Carry', value: 'Cash and a transport card' }
faq:
  ...
  - question: 'What should I actually carry for two weeks in Korea?'
    answer: 'A foreign card for hotels, department stores, chains and larger restaurants; enough cash for small restaurants, markets, some taxis and anywhere with an older terminal; and a prepaid transport card for buses, the subway and a surprising number of convenience-store purchases. Those three cover almost everything a visitor meets. What none of them cover is Korean apps that require a domestic card and identity verification — that is a different problem with a different answer.'
---
...
The second is normally worse, sometimes considerably. The offer appears at
card terminals, at ATMs and occasionally online.
...
Ordering screens in fast food, cinemas, some restaurants and ticket machines
are often domestic-card-only, and they are exactly the situation where you
cannot ask someone to try something else.

Where a counter exists, use the counter.
...
Delivery, shopping, booking and ticketing apps typically require a
**domestic card registered to a verified identity**. This is not a card
problem at all — it is the identity verification wall, and no foreign card
gets past it.

Which services this affects, and where each one actually stops, is in
...
<div class="callout callout-note">
  ...
  <p>Top-up machines are frequently domestic-card-only, so plan to load it
  with notes. Buying and topping up at a convenience store counter is the
  path with the fewest surprises.</p>
</div>
...
| Buses and subway | — | Awkward | Primary |
| Taxis | Sometimes | Reliable | Reliable |
| Convenience stores | Usually fine | Fine | Fine |
| Kiosks | Often refused | Sometimes | Sometimes |
| Korean apps | No | No | No |
